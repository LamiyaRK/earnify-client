...
const Nav = () => {
  ...
  const list1 = (
    <>
      ...
      <p><a href='https://github.com/LamiyaRK/earnify-client' target='_blank'><button className="btn btn-neutral py-6 px-6 rounded-full">Join as Developer</button></a></p>
  ...
  <li><a href='https://github.com/LamiyaRK/earnify-client' target='_blank'>Join as Developer</a></li>
