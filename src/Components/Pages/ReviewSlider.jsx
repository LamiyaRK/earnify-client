  ...
  const reviews = [
    {
      ...
      description: 'I never thought micro-tasking could be this smooth. Earnify made it simple, and I got paid within days!',
      name: 'Sara Ahmed',
    ...
    },
    {
      ...
      description: 'Seriously. Just by doing small tasks while commuting. Best micro-job platform I’ve used so far.',
      name: 'Jonathan Smith',
